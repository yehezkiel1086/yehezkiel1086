...
Secure Backend / DevSecOps Engineer specializing in production-grade experience architecting Go (Golang) microservices and distributed systems — backed by Penetration Testing, Application Security and Network Security. This dual background means I understand vulnerabilities from both sides: as an attacker probing for weaknesses, and as an engineer who has built and deployed the systems being attacked.
