...
Backend Engineer and Cyber Security Professional specializing in Penetration Testing, Application Security, Network Security, and DevSecOps — backed by production-grade experience architecting Go (Golang) microservices and distributed systems. This dual background means I understand vulnerabilities from both sides: as an attacker probing for weaknesses, and as an engineer who has built and deployed the systems being attacked.
